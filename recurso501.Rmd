...
Siguiendo la notación utilizada previamente, formulamos la hipótesis nula ($H_0$) que establece que la proporción de tapas azules es $P=1/2$, es decir, el 50% del total. Esta hipótesis implica que, en un número muy grande de botellas producidas, aproximadamente la mitad debería tener tapas azules y la otra mitad rojas.
...
En el ámbito de la investigación, la formulación de la prueba de hipótesis suele diseñarse de manera que el rechazo de la hipótesis nula 
($H_0$) implique la obtención de un nuevo hallazgo o evidencia que respalde un cambio significativo en el fenómeno estudiado. Por el contrario, no rechazar $H_0$  indica que los datos no proporcionan suficiente evidencia para afirmar que se ha producido una modificación respecto a la situación de referencia previamente establecida.
...
El segundo cambio clave fue la introducción de una **hipótesis alternativa** (\( H_1 \)), la cual se contrapone a la **hipótesis nula** (\( H_0 \)). En este esquema, \( H_1 \) representa la afirmación que se busca demostrar con la evidencia empírica. Así, cuando los datos observados proporcionan suficiente evidencia en contra de \( H_0 \), se opta por rechazarla en favor de \( H_1 \), indicando que los resultados son más compatibles con esta última.  

A partir de este modelo, que es el que se utiliza en adelante, a continuación se prsenta su aplicación en un contexto educativo.  
...
- **Hipótesis nula (\( H_0 \))**: "El rendimiento promedio de los estudiantes provenientes de hogares con un alto nivel educativo es superior o igual al promedio general."  
- **Hipótesis alternativa (\( H_1 \))**: "El rendimiento promedio de los estudiantes provenientes de hogares con un alto nivel educativo es inferior al promedio general."  
