...
Esta sección se inicia con el modelo **Bernoulli**, que, aunque algunos autores no lo consideran un modelo en sí mismo, es fundamental para comprender otros modelos de probabilidad discreta. Su nombre proviene del matemático **Jacob Bernoulli** y describe experimentos que cumplen las siguientes condiciones:
